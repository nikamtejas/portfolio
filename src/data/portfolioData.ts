export const personalInfo = {
  name: "Tejas Nikam",
  title: "Data Analyst | MSc Management & Data Science | Full-Stack Developer",
  tagline: "Transforming data into actionable insights and building scalable applications that drive business value.",
...
export const education = [
  {
    id: 1,
    degree: "MSc Management & Data Science",
    institution: "Leuphana University",
    location: "Lüneburg, Germany",
    period: "10/2025 - Present",
    description: "Focusing on advanced analytics, machine learning, and data-driven business strategies.",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    degree: "German Language (TestDaF Preparatory Course)",
